...
const pillars = [
  ...
  },
  {
    ...
    title: "Components",
    description:
      "The pieces the product is built from, with the props they take and the rules they hold.",
    link: "/components",
  },
  {
    token: "guides",
    title: "Guides",
    description:
      "Theming, governance, enforcement and migration. How the system stays honest over time.",
    link: "/guides",
  },
];
...
const paths = [
  ...
  },
  {
    ...
    description:
      "Build a plugin that reads as part of Caido, using the same tokens the product uses.",
