export default {
  ...
  eventMarker: {
    class: [
      ...
      // Appearance
      "rounded-full border-2 border-line-default bg-surface-page",

      // Before
      "before:rounded-full before:w-[0.375rem] before:h-[0.375rem] before:bg-fill-primary",
      // After
