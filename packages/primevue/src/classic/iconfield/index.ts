export default {
  root: {
    class: [
      ...
      "[&>[data-pc-name=inputicon]]:text-surface-600 dark:[&>[data-pc-name=inputicon]]:text-white/60",
      ...
      "[&>[data-pc-extend=inputicon]]:text-surface-600 dark:[&>[data-pc-extend=inputicon]]:text-white/60",
