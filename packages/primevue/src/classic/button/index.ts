export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            // Primary Button
            {
                'text-surface-0': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'bg-primary-700': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'border border-primary-700': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // Primary Text Button
            { 'text-primary-600': props.text && props.severity === null && !props.plain },
            // Primary Outlined Button
            { 'text-primary-700 border border-primary-700': props.outlined && props.severity === null && !props.plain },
            ...
            // Info Button
            {
                ...
                'bg-blue-500 dark:bg-info-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                'border border-blue-500 dark:border-info-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain
            },
            // Info Text Button
            { 'text-info-400 dark:text-info-400': props.text && props.severity === 'info' && !props.plain },
            // Info Outlined Button
            { 'text-info-400 border border-info-400 hover:bg-info-300/10 ': props.outlined && props.severity === 'info' && !props.plain },
            ...
            // Danger Button
            {
                ...
                'border border-danger-500 dark:border-danger-400': props.severity === 'danger' && !props.text && !props.outlined && !props.plain
            },
            // Danger Text Button
            { 'text-danger-400 dark:text-danger-400': props.text && props.severity === 'danger' && !props.plain },
            // Danger Outlined Button
            { 'text-danger-400 border border-danger-400 hover:bg-danger-300/10': props.outlined && props.severity === 'danger' && !props.plain },
            ...
            { 'focus:ring-blue-400 dark:focus:ring-info-300': props.severity === 'info' },
            // Text & Outlined Button
            { 'hover:bg-info-300/10': (props.text || props.outlined) && props.severity === 'info' && !props.plain },
            ...
            // Text & Outlined Button
            { 'hover:bg-danger-300/10': (props.text || props.outlined) && props.severity === 'danger' && !props.plain },
